...
function CertificatePage() {
    ...
    const filteredCertificates = achievementData.achievements.filter((achieve) => {
        const content = achieve.title + achieve.details + achieve.date
    ...
    return (
        <div className="certificatePage" style={{backgroundColor: theme.secondary}}>
            ...
            <div className="certificatePage-header" style={{backgroundColor:theme.primary}}>
                <Link to="/">
           ...
           <div className="certificatePage-container">
               <div className="certificatePage-search">
               ...
               <div className="certificate-container">
                   <Grid className="certificate-grid" container direction="row" alignItems="center" justifyContent="center">
                        {filteredCertificates.map(achieve => (
                            <SingleCertificate
                                theme={theme}
                                key={achieve.id}
                                id={achieve.id}
